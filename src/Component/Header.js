        ...
        <section className="header-area">
                    ...
                    >
                      <ul className="navbar-nav ml-auto">
                        <li className="nav-item">
                          <a className="page-scroll" href="#selection">
                            Selection
                          </a>
                        </li>
                        <li className="nav-item">
                          <a className="page-scroll" href="#ITRaisesIT">
                            ITRaisesIT
                          </a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                          <a className="page-scroll" href="#leadership">
                            Leadership
                          </a>
                        </li>
                        <li className="nav-item">
              ...
              >
                ...
                <div className="carousel-inner">
                  <div
                    ...
                    style={{
                      backgroundImage: "url(assets/images/Slide/slide1.jpg)",
                      opacity: 0.8,
                    }}
                  >
                        ...
                        <div className="col-xl-6 col-lg-7 col-sm-10 pd-50">
                          <div className="row">
                            <ul className="carousel-btn rounded-buttons">
                              <h2 className="slider2">
                                Passerelles numériques means “digital bridge“, a
                                metaphor for providing free IT training programs
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: "url(assets/images/Slide/study.jpg)",
                      opacity: 0.8,
                    }}
                  >
                    <div className="carousel-caption">
                        ...
                        <div className="row">
                          <div className="col-xl-6 col-lg-7 col-sm-10 pd-50">
                            <ul className="carousel-btn rounded-buttons text-right">
                              <h1 className="slider2">
                                Our actions in Vietnam
                              </h1>
                              <h2 className="slider2">
                                Launched in 2010 in Danang, Passerelles
                                numériques Vietnam (PNV) offers full
                                scholarships to our 3-year, high-quality IT
                                training program in: Web Development, Mobile
                                Development & Automated Testing. Each of these
                                specializations is taught holistically,
                                including both technical and soft skills
                                alongside a robust personal development program.
                              </h2>
                              <li>
                                <a className="main-btn rounded-three" href="#">
                                  DONATE
                  ...
                  <div
                    className="carousel-item bg_cover"
                    style={{
                      backgroundImage: "url(assets/images/Slide/beach.JPG)",
                      opacity: 0.8,
                    }}
                  >
                    <div className="carousel-caption">
                      <div className="container">
                        <div className="row">
                          <div className="col-xl-6 col-lg-7 col-sm-10 pd-50">
                            <ul className="carousel-btn rounded-buttons">
                              <h2 className="slider2">
                                Since 2010, PN Vietnam has transformed the lives
                                of more than 500 underprivileged youth through
                                IT education.
                              </h2>
                              <li>
                                <a className="main-btn rounded-three" href="#">
          ...
          <div className="d-block d-md-flex intro-engage">
            <div className="col-md-4">
              ...
              <p>
                PN strives to enrol a ratio of at least 50% girls (or a maximum
                of two thirds) at each of our centers.
              </p>
            </div>
            <div className="col-md-4">
              <h3>No Poverty</h3>
              <p>
                At least 90% of the students enrolled in our programs can escape
                poverty, be professionally more successful relatively to the
                national average, and take advantage of a ‘Gateway for Life’.
              </p>
            </div>
            <div className="col-md-4">
              <h3>Free Education</h3>
              <p>
                Our students stay together in Danang for 3 years for their
                studies, with all academic and daily expenses covered by PNV.{" "}
              </p>
            </div>
          </div>
        </section>
