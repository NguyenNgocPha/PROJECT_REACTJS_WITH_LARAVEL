...
export default class EditSharing extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        console.log(id);
        axios.get(`http://localhost:8000/api/sharing/` + id)
            .then(res => {
                this.setState({
    ...
    onSubmit = (e) => {
        ...
        axios
            .post(`http://localhost:8000/api/sharing/` + this.props.match.params.id, formData)
            .then((res) => {
        ...
        return (
            <div className="w3-card-6 w3-border w3-center w3-text-yellow" style={{ width: '60%', margin:'auto' }}>
                <div class="w3-container w3-orange w3-text-blue ">
                    <h2 className="w3-serif w3-text-black">Edit new Sharing</h2>
                </div>
                <form
                ...
                >
                    ...
                    <div class="w3-container">
                        <label className="w3-serif" style={{fontSize:'25px'}}> <i class="fas fa-signature"></i>Share</label>
                        <input className="w3-input w3-serif" style={{fontSize:'20px'}}
                            type="text"
                            name="share"
